...
public class AdGridViewAdapter extends BaseAdapter {
    ...
    private int layoutId = R.layout.view_menu;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder.textView = findViewById(convertView, R.id.menu_name);
            holder.imageView = findViewById(convertView, R.id.menu_icon);
